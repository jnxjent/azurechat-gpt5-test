...
_COL_HDR_FONT = Font(name="Meiryo", bold=True, color="FFFFFF")
_ROW_HDR_FILL = PatternFill(start_color="D9E1F2", end_color="D9E1F2", fill_type="solid")
_ROW_HDR_FONT = Font(name="Meiryo", bold=True, color="000000")
_STUB_FILL = PatternFill(start_color="BDD7EE", end_color="BDD7EE", fill_type="solid")
_STUB_FONT = Font(name="Meiryo", bold=True, color="000000")
_BODY_FONT = Font(name="Meiryo")
